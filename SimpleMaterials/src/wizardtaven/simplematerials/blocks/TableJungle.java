 ...
 *
 */
public class TableJungle extends GenericCustomBlock {
	
	private SimpleMaterials _SimpleMaterials;
	
	public static final String _name = "Jungle Table";
	public final String _shapeFileName = "table";
	public final String _textureURL = "http://dl.dropbox.com/u/82409066/Textures/table_jungle.png";

	/**
	 * Constructs the Table.
	 */
	public TableJungle(SimpleMaterials instance) {
