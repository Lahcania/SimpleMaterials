 ...
 *
 */
public class TableStone extends GenericCustomBlock {
	
	private SimpleMaterials _SimpleMaterials;
	
	public static final String _name = "Stone Table";
	public final String _shapeFileName = "table";
	public final String _textureURL = "http://dl.dropbox.com/u/82409066/Textures/table_stone.png";

	/**
	 * Constructs the Table.
	 */
	public TableStone(SimpleMaterials instance) {
