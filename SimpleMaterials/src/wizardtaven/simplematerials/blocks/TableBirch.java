 ...
 *
 */
public class TableBirch extends GenericCustomBlock {
	
	private SimpleMaterials _SimpleMaterials;
	
	public static final String _name = "Birch Table";
	public final String _shapeFileName = "table";
	public final String _textureURL = "http://dl.dropbox.com/u/82409066/Textures/table_birch.png";

	/**
	 * Constructs the Table.
	 */
	public TableBirch(SimpleMaterials instance) {
