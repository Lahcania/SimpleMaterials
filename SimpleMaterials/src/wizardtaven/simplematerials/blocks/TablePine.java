 ...
 *
 */
public class TablePine extends GenericCustomBlock {
	
	private SimpleMaterials _SimpleMaterials;
	
	public static final String _name = "Pine Table";
	public final String _shapeFileName = "table";
	public final String _textureURL = "http://dl.dropbox.com/u/82409066/Textures/table_pine.png";

	/**
	 * Constructs the Table.
	 */
	public TablePine(SimpleMaterials instance) {
