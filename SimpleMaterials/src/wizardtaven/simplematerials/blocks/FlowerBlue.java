 ...
 *
 */
public class FlowerBlue extends GenericCustomBlock {
	
	private SimpleMaterials _SimpleMaterials;
	
	public static final String _name = "Skybell";
	public final String _shapeFileName = "flower";
	public final String _textureURL = "http://dl.dropbox.com/u/82409066/items/skybells.png";

	/**
	 * Constructs the Table.
	 */
	public FlowerBlue(SimpleMaterials instance) {
	...
	private void createRecipes() {
		ItemStack result = new ItemStack(Material.INK_SACK, 2, (byte)(15 - DyeColor.CYAN.getData()));
